...
export default class CameraController
{
	...
	camera_focus_on_point()
	{
		this.set_state(new CameraFocusOnPointState());
	}

	pan_and_zoom(bounding_box, up_dir)
	{
		this.set_state(new CameraPanAndZoom(bounding_box, up_dir));
	}
