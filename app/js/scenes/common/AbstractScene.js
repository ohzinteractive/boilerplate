...
class AbstractScene extends Scene
{
  ...
  set_assets(scene_objects, scene_textures)
  {
    this.loading_states.regular.set_assets(scene_objects, scene_textures);
  }

  set_high_assets(scene_objects, scene_textures)
  {
    this.loading_states.high.set_assets(scene_objects, scene_textures);
  }
