import edge_line_vert from 'js/shaders/edges/edges_vert';
import edge_line_frag from 'js/shaders/edges/edges_frag';
import corners_vert from 'js/shaders/edges/corners_vert';
import corners_frag from 'js/shaders/edges/corners_frag';
