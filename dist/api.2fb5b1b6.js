...
},{}],"js/components/CameraController/states/CameraViewState.js":[function(require,module,exports) {
"use strict";
...
var CameraViewState = /*#__PURE__*/function () {
  function CameraViewState() {
    _classCallCheck(this, CameraViewState);
  }

  _createClass(CameraViewState, [{
    key: "on_enter",
    value: function on_enter(camera_controller) {}
  }, {
    key: "on_exit",
    value: function on_exit(camera_controller) {}
  }, {
    key: "update",
    value: function update(TIME, camera_controller) {}
  }]);

  return CameraViewState;
}();

exports.default = CameraViewState;
},{}],"js/components/CameraController/states/CameraDebugState.js":[function(require,module,exports) {
"use strict";
...
var _ohziCore = require("ohzi-core");

var _CameraViewState2 = _interopRequireDefault(require("../states/CameraViewState"));
...
var CameraDebugState = /*#__PURE__*/function (_CameraViewState) {
  _inherits(CameraDebugState, _CameraViewState);

  var _super = _createSuper(CameraDebugState);

  function CameraDebugState(oobb) {
    var _this;

    _classCallCheck(this, CameraDebugState);

    _this = _super.call(this);
    _this.pan_speed = new THREE.Vector2();
    _this.zoom_speed = 0;
    _this.zoom_t = 0;
    _this.tilt_degrees = 70;
    _this.tilt_speed = 0;
    _this.vector_down_axis = new THREE.Vector3(0, -1, 0);
    _this.vector_up_axis = new THREE.Vector3(0, 1, 0);
    _this.vector_back_axis = new THREE.Vector3(0, 0, -1);
    _this.vector_left_axis = new THREE.Vector3(-1, 0, 0);
    _this.tmp_dir = new THREE.Vector3();
    _this.tmp_ray = new THREE.Ray();
    _this.tmp_intersection = new THREE.Vector3();
    _this.tmp_mouse_dir = new THREE.Vector2();
    _this.last_point = new THREE.Vector3();
    return _this;
  }

  _createClass(CameraDebugState, [{
    key: "on_enter",
    value: function on_enter(camera_controller) {
      this.t_damping = 0;
    }
    ...
    key: "update",
    value: function update(camera_controller) {
      if (!camera_controller.input_enabled) {
        return;
      }

      if (camera_controller.camera.isOrthographicCamera) {
        camera_controller.reference_zoom += _ohziCore.Input.wheel_delta * (camera_controller.max_zoom - camera_controller.min_zoom) * 0.01;
      } else {
        camera_controller.reference_zoom -= _ohziCore.Input.wheel_delta * (camera_controller.max_zoom - camera_controller.min_zoom) * 0.01;
      }

      if (_ohziCore.Input.left_mouse_button_down) {
        camera_controller.set_rotation_delta(_ohziCore.Input.mouse_dir.x * -15.5, _ohziCore.Input.mouse_dir.y * 10.5);
      }

      if (_ohziCore.Input.right_mouse_button_pressed) {
        this.last_point.copy(_ohziCore.Input.NDC);
      }

      if (_ohziCore.Input.right_mouse_button_down) {
        var prev_point = _ohziCore.CameraUtilities.get_plane_intersection(camera_controller.reference_position, undefined, this.last_point).clone();

        var current_point = _ohziCore.CameraUtilities.get_plane_intersection(camera_controller.reference_position, undefined, _ohziCore.Input.NDC).clone();
...
}(_CameraViewState2.default);

exports.default = CameraDebugState;
},{"ohzi-core":"../node_modules/ohzi-core/index.js","../states/CameraViewState":"js/components/CameraController/states/CameraViewState.js"}],"js/components/CameraController/states/RotationOnly.js":[function(require,module,exports) {
"use strict";
...
var RotationOnly = /*#__PURE__*/function (_CameraViewState) {
  _inherits(RotationOnly, _CameraViewState);

  var _super = _createSuper(RotationOnly);

  function RotationOnly(oobb) {
    var _this;

    _classCallCheck(this, RotationOnly);
...
exports.default = RotationOnly;
},{"../states/CameraViewState":"js/components/CameraController/states/CameraViewState.js","ohzi-core":"../node_modules/ohzi-core/index.js"}],"js/components/CameraController/movement_mode/CameraMovementMode.js":[function(require,module,exports) {
"use strict";
...
var CameraMovementMode = /*#__PURE__*/function () {
  function CameraMovementMode() {
    _classCallCheck(this, CameraMovementMode);
  }

  _createClass(CameraMovementMode, [{
    key: "on_enter",
    value: function on_enter(camera_controller) {}
  }, {
    key: "on_exit",
...
exports.default = CameraMovementMode;
},{}],"js/components/CameraController/movement_mode/ImmediateMode.js":[function(require,module,exports) {
"use strict";
...
var _CameraMovementMode2 = _interopRequireDefault(require("./CameraMovementMode"));
...
var ImmediateMode = /*#__PURE__*/function (_CameraMovementMode) {
  _inherits(ImmediateMode, _CameraMovementMode);

  var _super = _createSuper(ImmediateMode);

  function ImmediateMode() {
    var _this;

    _classCallCheck(this, ImmediateMode);

    _this = _super.call(this);
    _this.rotation_speed = new THREE.Vector2();
    _this.vector_up_axis = new THREE.Vector3(0, 1, 0);
    _this.vector_forward_axis = new THREE.Vector3(0, 0, -1);
    _this.tmp_up1 = new THREE.Vector3();
    _this.tmp_up2 = new THREE.Vector3();
    _this.tmp_forward = new THREE.Vector3();
    _this.tmp_new_pos = new THREE.Vector3();
    _this.tmp_quat = new THREE.Quaternion();
    _this.tmp_camera_target_pos = new THREE.Vector3();
    return _this;
  }

  _createClass(ImmediateMode, [{
    key: "on_enter",
    value: function on_enter(camera_controller) {
    ...
    key: "update",
    value: function update(camera_controller) {
      camera_controller.camera.quaternion.copy(camera_controller.reference_rotation); // camera_controller.camera.quaternion.slerp(camera_controller.reference_rotation, 0.8);

      this.tmp_forward.copy(this.vector_forward_axis);
      var dir = this.tmp_forward.applyQuaternion(camera_controller.camera.quaternion);
      camera_controller.reference_zoom = THREE.Math.clamp(camera_controller.reference_zoom, camera_controller.min_zoom, camera_controller.max_zoom);
    ...
    key: "get_target_camera_pos",
    value: function get_target_camera_pos(camera_controller) {
      this.tmp_quat.copy(camera_controller.reference_rotation);
      this.tmp_forward.copy(this.vector_forward_axis);
      var dir = this.tmp_forward.applyQuaternion(this.tmp_quat);
      var zoom = THREE.Math.clamp(camera_controller.reference_zoom, camera_controller.min_zoom, camera_controller.max_zoom);
...
}(_CameraMovementMode2.default);

exports.default = ImmediateMode;
},{"./CameraMovementMode":"js/components/CameraController/movement_mode/CameraMovementMode.js"}],"js/components/CameraController/CameraController.js":[function(require,module,exports) {
"use strict";
...
var _CameraViewState = _interopRequireDefault(require("./states/CameraViewState"));

var _CameraDebugState = _interopRequireDefault(require("./states/CameraDebugState"));

var _RotationOnly = _interopRequireDefault(require("./states/RotationOnly"));

var _ImmediateMode = _interopRequireDefault(require("./movement_mode/ImmediateMode"));
...
var CameraController = /*#__PURE__*/function () {
  function CameraController() {
    ...
    this.current_state = new _CameraViewState.default();
    this.current_mode = new _ImmediateMode.default();
    ...
    this.zoom = _ohziCore.Configuration.max_zoom_distance / 2;
    this.reference_zoom = _ohziCore.Configuration.max_zoom_distance / 2;
  ...
  _createClass(CameraController, [{
    key: "set_camera",
    value: function set_camera(camera) {
      this.camera = camera;
    ...
    key: "set_normalized_zoom",
    value: function set_normalized_zoom(zoom) {
      this.normalized_zoom = THREE.Math.clamp(zoom, 0, 1);
    }
  }, {
    key: "update_normalized_zoom",
    value: function update_normalized_zoom(min_zoom, max_zoom) {
      var zoom = this.camera.position.distanceTo(this.reference_position);
    ...
    key: "set_idle",
    value: function set_idle() {
      this.set_state(new _CameraViewState.default());
    }
  }, {
    key: "set_debug_mode",
    value: function set_debug_mode() {
      this.set_state(new _CameraDebugState.default());
    }
  }, {
    key: "set_rotation_only_mode",
    value: function set_rotation_only_mode() {
      this.set_state(new _RotationOnly.default());
    }
  }, {
    key: "camera_is_zoomed_out",
    value: function camera_is_zoomed_out() {
      return this.normalized_zoom < 0.2;
    }
  }, {
    key: "set_rotation",
    value: function set_rotation(tilt, orientation) {
    ...
    key: "set_tilt",
    value: function set_tilt(tilt) {
      var new_tilt = new THREE.Quaternion().setFromAxisAngle(this.vector_right_axis, -tilt / 360 * Math.PI * 2);
      var old_tilt = new THREE.Quaternion().setFromAxisAngle(this.vector_right_axis, -this.current_tilt / 360 * Math.PI * 2);
      old_tilt.conjugate();
      this.reference_rotation.multiply(old_tilt).multiply(new_tilt);
      this.current_tilt = tilt;
    }
  }, {
    key: "set_rotation_delta",
    value: function set_rotation_delta(delta_x, delta_y) {
    ...
    key: "lerp_rotation",
    value: function lerp_rotation(from_tilt, to_tilt, from_orientation, to_orientation, t) {
      var raw_orientation = THREE.Math.lerp(from_orientation, to_orientation, t);
      ...
      this.set_rotation(THREE.Math.lerp(from_tilt, to_tilt, t), THREE.Math.lerp(from_orientation, to_orientation, t));
      this.current_orientation = raw_orientation;
    }
  }, {
    key: "build_rotation",
    value: function build_rotation(tilt, orientation) {
      var new_orientation = new THREE.Quaternion().setFromAxisAngle(this.vector_up_axis, -1 * (orientation / 360) * Math.PI * 2);
      var new_tilt = new THREE.Quaternion().setFromAxisAngle(this.vector_right_axis, -tilt / 360 * Math.PI * 2);
      return new_orientation.multiply(new_tilt);
    }
  }, {
    key: "translate_forward",
    value: function translate_forward(amount) {
      this.tmp_forward.copy(this.vector_forward_axis);
    ...
    key: "translate_right",
    value: function translate_right(amount) {
    ...
    key: "focus_camera_on_bounding_box",
    value: function focus_camera_on_bounding_box(bb) {
      if (this.camera.isOrthographicCamera) {
        bb.getSize(this.tmp_size);
        var obj_x = this.tmp_size.x;
        var obj_y = this.tmp_size.y;
        var object_aspect = obj_x / obj_y;
        if (_ohziCore.Screen.aspect_ratio / object_aspect > 1) this.camera.zoom = _ohziCore.Screen.height / obj_y;else this.camera.zoom = _ohziCore.Screen.width / obj_x;
        bb.getCenter(this.reference_position);
      } else {
        var dir = new THREE.Vector3();
        dir.copy(bb.max).sub(bb.min);
        var p1 = bb.min.clone();
        var p2 = p1.clone().add(new THREE.Vector3(dir.x, 0, 0));
        var p3 = p1.clone().add(new THREE.Vector3(0, dir.y, 0));
        var p4 = p1.clone().add(new THREE.Vector3(0, 0, dir.z));
        var p5 = p1.clone().add(new THREE.Vector3(dir.x, 0, dir.z));
        var p6 = p1.clone().add(new THREE.Vector3(0, dir.y, dir.z));
        var p7 = bb.max.clone();
        var p8 = p1.clone().add(new THREE.Vector3(dir.x, dir.y, 0));
        this.focus_camera_on_points([p1, p2, p3, p4, p5, p6, p7, p8], 1);
      }
    }
  }, {
    key: "get_zoom_to_focus_camera_on_bounding_box",
    value: function get_zoom_to_focus_camera_on_bounding_box(bb, tilt, orientation) {
      ...
      var original_zoom = this.reference_zoom;
      var original_pos = new THREE.Vector3().copy(this.reference_position);
      this.focus_camera_on_bounding_box(bb);
      var target_zoom = this.reference_zoom;
    ...
    key: "get_zoom_to_focus_on_points",
    value: function get_zoom_to_focus_on_points(points, scale) {
      var old_zoom = this.reference_zoom;
      var old_pos = new THREE.Vector3().copy(this.reference_position);
      this.focus_camera_on_points(points, scale);
      var new_zoom = this.reference_zoom;
      this.reference_zoom = old_zoom;
      this.reference_position.copy(old_pos);
      return new_zoom;
    }
  }, {
    key: "get_target_pos_to_focus_on_points",
    value: function get_target_pos_to_focus_on_points(points, scale) {
      var old_zoom = this.reference_zoom;
      var old_pos = new THREE.Vector3().copy(this.reference_position);
      this.focus_camera_on_points(points, scale);
      var new_pos = this.reference_zoom.clone();
      this.reference_zoom = old_zoom;
      this.reference_position.copy(old_pos);
      return new_pos;
    }
  }, {
    key: "focus_camera_on_sphere",
    value: function focus_camera_on_sphere(sphere, debug) {
      this.reference_zoom = this.get_zoom_to_sphere(sphere, debug);
      this.reference_position.copy(sphere.center);
    }
  }, {
    key: "get_zoom_to_sphere",
    value: function get_zoom_to_sphere(sphere, debug) {
      var v_fov = this.camera.fov / 2 * Math.PI / 180;
      var h_fov = 2 * Math.atan(Math.tan(v_fov) * this.camera.aspect) / 2;

      if (debug) {
        _ohziCore.Debug.draw_math_sphere(sphere);
      } //this.camera.zoom = 1/((sphere.radius*2) /(ViewApi.map.camera_controller.camera.top*2));
      // this.camera.updateProjectionMatrix();


      var distV = sphere.radius / Math.tan(v_fov);
      var distH = sphere.radius / Math.tan(h_fov);
      return Math.max(Math.abs(distH), Math.abs(distV));
    }
  }, {
    key: "focus_camera_on_points",
    value: function focus_camera_on_points(points, zoom_scale, debug) {
      var points_sphere = new THREE.Sphere().setFromPoints(points);
      var world_space_center = points_sphere.center;
      var camera_forward = new THREE.Vector3(0, 0, 1).applyQuaternion(this.reference_rotation);
      var near_plane = points_sphere.center.clone().add(camera_forward.clone().multiplyScalar(points_sphere.radius));
      var plane = new THREE.Plane().setFromNormalAndCoplanarPoint(camera_forward, near_plane);
      var projected_point = new THREE.Vector3();
      var points_on_plane = [];

      for (var i = 0; i < points.length; i++) {
        plane.projectPoint(points[i], projected_point);
        points_on_plane.push(projected_point.clone()); // if(debug)
        // {
      ...
      var up = new THREE.Vector3(0, 1, 0).applyQuaternion(this.reference_rotation);
      var right = up.clone().cross(camera_forward).normalize();
      var mat = new THREE.Matrix4().set(right.x, up.x, camera_forward.x, world_space_center.x, right.y, up.y, camera_forward.y, world_space_center.y, right.z, up.z, camera_forward.z, world_space_center.z, 0, 0, 0, 1);
      var inverse_mat = new THREE.Matrix4().getInverse(mat);

      for (var _i = 0; _i < points_on_plane.length; _i++) {
        points_on_plane[_i].applyMatrix4(inverse_mat);
      }
      ...
      if (debug) {
        // Debug.draw_axis()
        var geo_plane = _ohziCore.Debug.draw_plane(size.x, size.y);

        geo_plane.position.add(projected_center);
        geo_plane.updateMatrixWorld();
        geo_plane.applyMatrix(mat); // Debug.draw_cube(average_center, 50, undefined, 0x0000ff);

        for (var _i2 = 0; _i2 < points_on_plane.length; _i2++) {
          points_on_plane[_i2].applyMatrix4(mat); // if(debug)
    ...
    key: "get_current_tilt",
    value: function get_current_tilt() {
      return this.current_tilt;
    }
  }, {
    key: "get_current_orientation",
    value: function get_current_orientation() {
      return this.current_orientation;
    }
  }, {
    key: "__get_zoom_to_show_rect",
    value: function __get_zoom_to_show_rect(width, height) {
      var v_fov = this.camera.fov / 2 * Math.PI / 180;
      var h_fov = 2 * Math.atan(Math.tan(v_fov) * this.camera.aspect) / 2;
      var distV = height / Math.tan(v_fov);
      var distH = width / Math.tan(h_fov);
...
},{"ohzi-core":"../node_modules/ohzi-core/index.js","./states/CameraViewState":"js/components/CameraController/states/CameraViewState.js","./states/CameraDebugState":"js/components/CameraController/states/CameraDebugState.js","./states/RotationOnly":"js/components/CameraController/states/RotationOnly.js","./movement_mode/ImmediateMode":"js/components/CameraController/movement_mode/ImmediateMode.js"}],"MainApplication.js":[function(require,module,exports) {
"use strict";
...
var _CameraController = _interopRequireDefault(require("/js/components/CameraController/CameraController"));
...
var MainApplication = /*#__PURE__*/function (_BaseApplication) {
  _inherits(MainApplication, _BaseApplication);

  var _super = _createSuper(MainApplication);

  function MainApplication(renderer) {
    var _this;
    ...
    _this.camera_controller = new _CameraController.default();
    _this.normal_render_mode = new _ohziCore.NormalRender();
    return _this;
  }
  ...
  _createClass(MainApplication, [{
    key: "start",
    value: function start() {
      _ohziCore.Graphics.set_state(this.normal_render_mode);
      ...
      this.config = _ohziCore.ResourceContainer.get_resource("config");
    }
  }, {
    key: "update",
    value: function update() {}
    ...
    key: "on_resize",
    value: function on_resize() {
      _ohziCore.Graphics.on_resize();
    }
  }, {
    key: "__init_camera",
    value: function __init_camera() {
      var camera = new _ohziCore.PerspectiveCamera(60, _ohziCore.Screen.aspect_ratio, 0.1, 200);
      camera.updateProjectionMatrix();
      camera.position.z = 10;
      camera.clear_color.copy(new THREE.Color("#000000"));
      camera.clear_alpha = 1;
      _ohziCore.CameraManager.current = camera;
    }
  }, {
    key: "__init_camera_controller",
    value: function __init_camera_controller() {
      this.camera_controller.set_camera(_ohziCore.CameraManager.current);
...
}(_ohziCore.BaseApplication);

exports.default = MainApplication;
},{"ohzi-core":"../node_modules/ohzi-core/index.js","/js/components/CameraController/CameraController":"js/components/CameraController/CameraController.js"}],"api.js":[function(require,module,exports) {
"use strict";

var _ohziCore = require("ohzi-core");

var _MainApplication = _interopRequireDefault(require("./MainApplication"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

//APP
var application = new _MainApplication.default(_ohziCore.Graphics);
var render_loop = new _ohziCore.RenderLoop(application, _ohziCore.Graphics);
window.ViewApi = {
  init: function init(parameters) {
    var body = document.querySelector('body');
    var canvas = document.getElementById('main-canvas');
    _ohziCore.Configuration.is_mobile = parameters.is_mobile;
    _ohziCore.Configuration.is_ios = parameters.is_ios;
    _ohziCore.Configuration.is_ipad = parameters.is_ipad;

    _ohziCore.Graphics.init(canvas);

    _ohziCore.Input.init(body, canvas);

    _ohziCore.Debug.init(_ohziCore.Graphics);
  ...
  dispose: function dispose() {
    ...
    _ohziCore.Graphics._renderer.dispose();

    map.dispose();
  },
  draw_debug_axis: function draw_debug_axis() {
    _ohziCore.Debug.draw_axis();
  },
  register_event: function register_event(name, callback) {
    _ohziCore.EventManager.on(name, callback);
  },
  resize_canvas: function resize_canvas() {
    application.on_resize();
  },
  resource_loading_completed: function resource_loading_completed() {
    application.resources_fully_loaded();
  },
  set_resource: function set_resource(name, resource) {
    _ohziCore.ResourceContainer.set_resource(name, resource);
  },
  ...
  config: _ohziCore.Configuration,
  resource_container: _ohziCore.ResourceContainer
};
},{"ohzi-core":"../node_modules/ohzi-core/index.js","./MainApplication":"MainApplication.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
