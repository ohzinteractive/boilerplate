...
var on_api_ready = function on_api_ready() {
  ViewApi.init(api_parameters);
  ViewApi.resource_loading_completed();
  ViewApi.start();
  var main_canvas = document.getElementById("main-canvas"); // set the size of the drawingBuffer
...
var on_config_ready = function on_config_ready() {
  var config = ViewApi.resource_container.get_resource("config");
  batch = new _ohziCore.ResourceBatch(); // batch.add_texture("fisheye_tex", "textures/snapshot_250.jpg");
...
var check_resource_loading = function check_resource_loading(batch, on_resources_loaded) {
...
var batch = new _ohziCore.ResourceBatch();
batch.add_json('config', 'data/config.json');
batch.load(ViewApi.resource_container);
check_resource_loading(batch, on_config_ready);
},{"ohzi-core":"../node_modules/ohzi-core/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
var OVERLAY_ID = '__parcel__error__overlay__';
var OldModule = module.bundle.Module;
